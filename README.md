...
5. Аргумент ячеек памяти имеет размер 32 бита.
6. Количество ячеек в памяти 256.
7. Ячейки стеков состоят только из аргументов.
8. Ячейки стека имеет размер 32 бита.
