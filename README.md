...
2. Если в строке есть символ ":", то эта строка является меткой и
...
4. Если строка - это инструкция без аргумента, то добавляем в список инструкций
   элемент состоящий из index, opcode, term
6. Если строка - это инструкция с аргументом, то добавляем в список инструкций
...
4. ```ControlUnit``` -  [ControlUnit](#ControlUnit)
